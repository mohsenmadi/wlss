...
<div id="payEft"  >
		...
		<div class="row">
			<div class="col-sm-12" style="text-align: center;"> <span style="color: #20495e;"><strong>EFT Details</strong></span> </div>
		</div>
		...
		<div class="row">
			...
			<div class="col-sm-7">
				<g:textField name="eName"  placeholder="Name of account holder" value="${payPref?.name}" size="45"/>
			 </div>	
		</div> <!-- name Row -->
...
<div class="row">		
	...
	<div class="col-sm-11"  ><p>
		<g:checkBox type="hidden" id="cSaveInfo" name="cSaveInfo" checked="${payPref?.preferred}"/>&nbsp;
